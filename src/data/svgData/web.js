export default {
    ...
    <svg version="1.1" id="backend" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;overflow:visible" xml:space="preserve">
        <defs>
            <clipPath id="backendClipPathTwo">
                    <rect x="252" y="0" height="510" width="250"></rect>
            </clipPath>
        </defs>
        <g>
            <g>
        ...
        <g id="backendBar">
            <g clip-path="url(#backendClipPathTwo)">
